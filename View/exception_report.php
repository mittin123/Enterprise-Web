                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="table-data__tool">
                                    ...
                                    <p style="font-size: 30px">Students without personal tutor</p>
                                    </div>
                                </div>
                                ...
                                <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach($data['student_without_tutor'] as $item){
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                    <p style="font-size: 30px">Student without interaction for 7 days</p>
                                    </div>
                                </div>
                                <div class="table-responsive table--no-card m-b-40">
                                <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <?php foreach($data['student_without_interaction']['7_days_type'] as $item){
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                    <p style="font-size: 30px">Student without interaction for 28 days</p>
                                    </div>
                                </div>
                                <div class="table-responsive table--no-card m-b-40">
                                <table class="table table-borderless table-striped table-earning">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                    <p style="font-size: 30px">Tutor withou interaction for 7 days</p>
                                    </div>
                                </div>
                                <div class="table-responsive table--no-card m-b-40">
                                <table class="table table-borderless table-striped table-earning">

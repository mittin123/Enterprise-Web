                                ...
                                <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Number of message in the last 7 days</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            ?>
                                            <tr>
                                                <td><b><?=$item['tutor_name']?></b></td>
                                                <td><?=round($item['average_message'],2)?></td>
                                                <td><?=$item['7_days_message']?></td>
                                            </tr>
                                            <?php
                                                }
                                            ?>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                    <p style="font-size: 30px">Number of arrangement for each tutor</p>
                                    </div>
                                </div>
                                <div class="table-responsive table--no-card m-b-40">
                                <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                <th>Tutor name</th>
                                                <th>Number of arangement in the last 7 days</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                            foreach($data['arrange'] as $item){
                                        ?>
                                            <tr>
                                                <td><b><?=$item['tutor_name']?></b></td>
                                                <td><?=$item['7_days_arrangement']?></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>

              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <a href="view_blog.php?delete_id=<?=$data['id']?>"><button type="button" class="btn btn-danger ">Delete</button></a>
                    <a href="view_blog.php?update_id=<?=$data['id']?>"><button type="button" class="btn btn-primary">Edit</button></a> <!-- Chỉ hiện ra khi đã đăng nhập -->
                    </div>
                  </div>
                  <div class="card-body">

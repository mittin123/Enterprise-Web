...
?>
<link href="View/css/toastr.css" rel="stylesheet" media="all">
...
<div class="page-container">
                    ...
                    <div class="col-md-12">
                        <div class="table-data__tool">
                            <div class="table-data__tool-left">
                                <h1>Tutor detail</h1>
                                <p>Tutor name: <?=$data['tutor']['name']?></p>
                                <p>Tutor email: <?=$data['tutor']['email']?></p>
                                <p>Number of students: <?=$data['tutor']['student_count']?>/10</p>
                            </div>
                            <div class="table-data__tool-right">
                                <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal"
                                    data-target="#scrollmodal" id="add">Add student</button>
                                </div>
                        </div>
                        <!-- DATA TABLE-->
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="scrollmodalLabel">Student List</h5>
                ...
                <div class="modal-body">
                            <table class="table table-borderless table-data3">
                                ...
                                <tbody class="response" id="popup_list"> 
    ...
    <script>
        $(document).ready(function () {
            var tutor_id = <?php echo $_GET['id'];?>;
            $('#add').click(function () {
                // AJAX request
                $.ajax({
                    url: 'load_student.php?tutor_id='+tutor_id,
                    type: 'post',
        ...
        function toast(element){
                ...
                var email = row.find("td:nth-child(2)");
                var id = row.find("td:nth-child(3)");
                var tutor_id = <?php echo $_GET['id'];?>;
                $(element).parent().parent().parent().remove();
                $('#std_list').append('<tr><td>'+name.text()+'</td><td>'+email.text()+'</td><td><a href=""><button type="button" class="btn btn-info" value="">Delete</button></a></td></tr>');
                $.ajax({
                    url: 'allocate_student.php',
                    type: 'post',
                    data:{
                        tutor_id: tutor_id,
                        student_id: id.text(),
